...
# Push Opencode server and TUI images to container registry
[group('agents')]
opencode-publish:
    ./apps/opencode/opencode.sh publish

# Bake official OpenCode binary, then push server and TUI imagery
[group('agents')]
opencode-binary-publish:
    ./apps/opencode/opencode.sh binary-publish
